...
# async def send_text(update: Update, context: ContextTypes):
#     msg= update.message.text
#     if msg == 'привет':
#         await update.message.reply_text(f'{update.effective_user.first_name}, Ещё раз привет!')
#     elif msg == 'пока':
#         await update.message.reply_text(update.effective_user.first_name, 'Пока!')